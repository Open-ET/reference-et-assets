...
def main(overwrite_flag=False):
    """"""
    print('\nIngesting ERA5-Land monthly bias correction ratio assets')
    ...
    bucket_name = 'openet'
    bucket_folder = (
        'bias_correction_gridwxcomp_testing/feb_runs/bias_outputs_era5land/'
    ...
    asset_folder = 'projects/openet/assets/reference_et/conus/era5land/ratios/v0/monthly'
    # coll_id = ''
...
def arg_parse():
    ...
    parser = argparse.ArgumentParser(
        description='Ingest ERA5-Land monthly bias correction ratio assets',
